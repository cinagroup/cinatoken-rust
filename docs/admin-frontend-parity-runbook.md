...
| Redemptions/topups | `/api/redemption`, topup/pay routes | P1/G4/G6 | Admin redemption-code management is implemented at `/api/redemption`, including list/search/get/create/update/delete/delete-invalid, D1 soft deletes, payment-compliance guard for code creation, and admin audit. Public topup/pay redemption remains deferred until double-credit prevention, webhook idempotency, and reconciliation evidence exist |
