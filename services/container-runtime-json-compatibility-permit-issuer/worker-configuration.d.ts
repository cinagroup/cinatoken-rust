/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/container-runtime-json-compatibility-permit-issuer/wrangler.jsonc --env-interface=JsonCompatibilityPermitIssuerGeneratedEnv services/container-runtime-json-compatibility-permit-issuer/worker-configuration.d.ts` (hash: d4b97e5737e513fda38fc79032c119c9)
// Runtime types generated with workerd@1.20260708.1 2026-08-04 
interface __BaseEnv_JsonCompatibilityPermitIssuerGeneratedEnv {
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ENVIRONMENT: "local";
	JSON_COMPATIBILITY_PERMIT_ISSUER_ENABLED: "false";
	JSON_COMPATIBILITY_ISSUER_AUTHORITY_ISSUER: "cinatoken-container-runtime-json-compatibility-invoker-staging";
	JSON_COMPATIBILITY_ISSUER_AUTHORITY_AUDIENCE: "cinatoken-container-runtime-json-compatibility-permit-issuer-staging";
	...
	JSON_COMPATIBILITY_PERMIT_ISSUANCE_AUTHORITY: DurableObjectNamespace<import("./src/index").JsonCompatibilityPermitIssuanceAuthority>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "JsonCompatibilityPermitIssuanceAuthority";
	}
	interface Env extends __BaseEnv_JsonCompatibilityPermitIssuerGeneratedEnv {}
}
interface JsonCompatibilityPermitIssuerGeneratedEnv extends __BaseEnv_JsonCompatibilityPermitIssuerGeneratedEnv {}
