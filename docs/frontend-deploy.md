...
7. On authenticated `/channels`, capture `Moonshot` as Partial with exactly
   chat/completions, completions, embeddings, rerank, and Messages; capture
   `SiliconFlow` as Partial with exactly chat/completions, completions,
