...
export const SHARD_PLACEMENT_APPLICATION_DISPATCH_CONSUMPTION_HMAC =
  Object.freeze({
    keyId: "application-dispatch-consumption-hmac-test-v1",
    credentialIdSha256: "5".repeat(64),
    secret:
      "application-dispatch-consumption-hmac-test-secret-0000000000000000",
  });
...
export function shardPlacementAuthorityEnv(overrides = {}) {
  ...
  return {
    ...
    SHARD_PLACEMENT_APPLICATION_DISPATCH_CONSUMPTION_HMAC_CURRENT_KID:
      SHARD_PLACEMENT_APPLICATION_DISPATCH_CONSUMPTION_HMAC.keyId,
    ...
    SHARD_PLACEMENT_APPLICATION_DISPATCH_CONSUMPTION_HMAC_CURRENT_SECRET:
      SHARD_PLACEMENT_APPLICATION_DISPATCH_CONSUMPTION_HMAC.secret,
