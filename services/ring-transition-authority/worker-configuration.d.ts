/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/ring-transition-authority/wrangler.jsonc --env-interface=RingTransitionAuthorityEnv services/ring-transition-authority/worker-configuration.d.ts` (hash: 2387f8d025d28c6e7565dac9dd28efc5)
// Runtime types generated with workerd@1.20260708.1 2026-07-23 
interface __BaseEnv_RingTransitionAuthorityEnv {
	DB: D1Database;
	...
	RING_TRANSITION_AUTHORITY_ISSUER: "cinatoken-ring-runner-local";
	RING_TRANSITION_AUTHORITY_AUDIENCE: "cinatoken-ring-transition-authority-local";
	...
	RING_TRANSITION_PERMIT_ISSUER: "cinatoken-ring-permit-issuer-local";
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_RingTransitionAuthorityEnv {}
}
interface RingTransitionAuthorityEnv extends __BaseEnv_RingTransitionAuthorityEnv {}
