...
function usage() {
  return [
    "Usage:",
    "  bun tools/plan_container_runtime_json_compatibility_campaign.mjs --campaign-id-sha256 <sha256> --controller-version-id <id> --runner-version-id <id> --runner-config-sha256 <sha256> --operator-version-id <id> --operator-config-sha256 <sha256> --operator-approval-key-id <kid> --operator-approval-spki-sha256 <sha256> --invoker-version-id <id> --invoker-config-sha256 <sha256> --permit-issuer-version-id <id> --permit-issuer-config-sha256 <sha256> --executor-version-id <id> --executor-config-sha256 <sha256> --runtime-n-build-id <sha256> --runtime-n-image-digest <sha256:...> --runtime-n-minus-one-build-id <sha256> --runtime-n-minus-one-image-digest <sha256:...> [--candidate-shard-index <index>] [--config <path>] [--out <create-only-plan.json>] [--json]",
