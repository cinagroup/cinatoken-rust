...
- **Status (2026-07-06): Gated substrate, upstream frame guard compiled.** The DO with WS
  ...
  oversized bridge frames with WebSocket close code 1009. **Remaining:**
