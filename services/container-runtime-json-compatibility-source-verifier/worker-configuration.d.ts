/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.jsonc --env-interface=JsonCompatibilitySourceVerifierGeneratedEnv` (hash: a32aa9d1dfd84809f89796bd37516e19)
...
interface __BaseEnv_JsonCompatibilitySourceVerifierGeneratedEnv {
	...
	JSON_COMPATIBILITY_SOURCE_BUNDLE_KEY_PREFIX: "container-runtime/json-compatibility/source-authentication/v2/sha256";
