...
const baseCapabilities: PlatformReadinessCapabilities = {
  ...
  subscription_funding_source_compiled: false,
  subscription_funding_source_runtime_ready: false,
  subscription_funding_source_staging_verified: false,
  subscription_funding_source_cutover_ready: false,
  ...
  quota_coordinator_reserve_observation_compiled: false,
  ...
  wfp_outbound_invocation_context_compiled: false,
  wfp_outbound_authority_verifier_compiled: false,
  wfp_outbound_replay_guard_compiled: false,
  ...
  realtime_flat_billing_compiled: false,
  realtime_flat_billing_runtime_ready: false,
  realtime_flat_billing_staging_verified: false,
  realtime_flat_billing_cutover_ready: false,
  task_v2_contract_version: 0,
  task_v2_ownership_compiled: false,
  task_v2_schema_ready: false,
  task_v2_runtime_ready: false,
  ...
  test('does not report every stage complete from compiled and bound state', () => {
    const summary = buildPlatformReadinessSummary(
      makeCapabilities({
        ...
        wfp_outbound_invocation_context_compiled: true,
        wfp_outbound_authority_verifier_compiled: true,
        wfp_outbound_replay_guard_compiled: true,
  ...
  test('keeps flat billing intent split across four fail-closed stages', () => {
    ...
    const verified = buildPlatformReadinessSummary(
      makeCapabilities({
        ...
        relay_flat_billing_intent_cutover_ready: true,
        subscription_funding_source_compiled: true,
        subscription_funding_source_runtime_ready: true,
  ...
  test('requires every backend cutover readiness field for stage success', () => {
    ...
    const ready = buildPlatformReadinessSummary(
      makeCapabilities({
        ...
        realtime_flat_billing_staging_verified: true,
        realtime_flat_billing_cutover_ready: true,
        task_v2_contract_version: 1,
        task_v2_ownership_compiled: true,
