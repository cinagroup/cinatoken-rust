...
from 122 to 102 by closing routes and removing one false-positive call:
...
102 calls with a stable SHA-256 route-set digest and category counts. New
...
payment families, operations work, and 6 visible admin gaps. Local wrapper
