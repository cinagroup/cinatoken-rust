/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/container-runtime-json-compatibility-executor/wrangler.jsonc --env-interface=JsonCompatibilityExecutorGeneratedEnv services/container-runtime-json-compatibility-executor/worker-configuration.d.ts` (hash: a8b707bc2946f12eccca65d87dad85da)
// Runtime types generated with workerd@1.20260708.1 2026-08-04 
interface __BaseEnv_JsonCompatibilityExecutorGeneratedEnv {
	...
	JSON_COMPATIBILITY_CAMPAIGN_AUTHORITY: DurableObjectNamespace<import("./src/index").JsonCompatibilityCampaignAuthority>;
	CONTAINER_CONTROLLER_JSON_PROBE: Service /* entrypoint JsonCompatibilityProbeEntrypoint from cinatoken-container-controller-staging */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "JsonCompatibilityCampaignAuthority";
	}
	interface Env extends __BaseEnv_JsonCompatibilityExecutorGeneratedEnv {}
}
interface JsonCompatibilityExecutorGeneratedEnv extends __BaseEnv_JsonCompatibilityExecutorGeneratedEnv {}
