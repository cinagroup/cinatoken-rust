...
from 122 to 104 by closing routes and removing one false-positive call:
...
104 calls with a stable SHA-256 route-set digest and category counts. New
...
payment families, operations work, and 8 visible admin gaps. Local wrapper
