/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/container-runtime-json-compatibility-operator/wrangler.jsonc --env-interface=JsonCompatibilityOperatorGeneratedEnv services/container-runtime-json-compatibility-operator/worker-configuration.d.ts` (hash: a610283d5f7459b75510634dd4f8a170)
