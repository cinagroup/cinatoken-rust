...
| Release closure | Orchestrator, release-verifier and publication/activation sources are mandatory in both clean-commit and signed-packet module inventories; closure now has 19 paths | Two isolated builds and independent DSSE packet over the exact committed candidate | Local closure pass; release open |
