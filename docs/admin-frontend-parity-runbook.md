...
| Remaining external payment callbacks/topups | Keep external subscription providers on Go until provider-specific signature/replay evidence exists; Stripe, Epay, legacy Waffo, Waffo Pancake, and Creem wallet paths are Worker-owned | Scenario C |
