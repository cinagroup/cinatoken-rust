/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/shard-placement-authority/wrangler.jsonc --env-interface=ShardPlacementAuthorityEnv services/shard-placement-authority/worker-configuration.d.ts` (hash: 5a7d4a3f9a56f7cad9a88fc73a73ea0f)
