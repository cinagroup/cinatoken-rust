...
- **Status (2026-07-06): Gated substrate, upstream event trace compiled.** The DO with WS
  ...
  upstream call.
  **Remaining:** production bridge hardening (live queue/drain proof and full
  live protocol replay evidence), usage
