/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.toml --env-interface=JsonCompatibilityCallerGeneratedEnv` (hash: cf814b38de7501d188450d11535aaa0a)
// Runtime types generated with workerd@1.20260708.1 2026-08-05 nodejs_compat
interface __BaseEnv_JsonCompatibilityCallerGeneratedEnv {
	...
	JSON_COMPATIBILITY_RUNNER_SERVICE: Service /* entrypoint JsonCompatibilityCampaignRunnerEntrypoint from cinatoken-container-runtime-json-compatibility-runner-staging */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env extends __BaseEnv_JsonCompatibilityCallerGeneratedEnv {}
}
interface JsonCompatibilityCallerGeneratedEnv extends __BaseEnv_JsonCompatibilityCallerGeneratedEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "JSON_COMPATIBILITY_CALLER_ENABLED" | "JSON_COMPATIBILITY_CALLER_STATUS_READ_ENABLED" | "JSON_COMPATIBILITY_CALLER_RUNNER_VERSION_ID" | "JSON_COMPATIBILITY_CALLER_RUNNER_CONFIG_SHA256">> {}
}
