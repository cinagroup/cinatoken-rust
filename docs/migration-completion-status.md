...
- Remaining non-Stripe payment providers: Creem/Waffo wallet
  checkout/callbacks and external subscription provider checkout/callbacks
  (including Waffo Pancake subscription settlement). Waffo Pancake wallet
  checkout/webhook is Worker-owned.
