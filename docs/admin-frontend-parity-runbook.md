...
| Remaining external payment callbacks/topups | Keep Creem/Waffo/Waffo-Pancake wallet checkout/callbacks and external subscription providers on Go until provider-specific signature/replay evidence exists; Stripe and Epay wallet paths are Worker-owned | Scenario C |
