...
| Cross-language vector | **RUST + INDEPENDENT BUN/WEBCRYPTO PASS; BEGIN `u32be` AND ROOT `u64be` FRAMING SEPARATE** |
...
| Typed phase subjects | **LOCAL VERIFIED; 22-FIELD BEGIN INTENT FREEZES ACTION INPUTS, ACTION SUBSTITUTION REJECTED, THREE CANONICAL SUBJECTS, EXACT PARENT CHAIN, FROZEN REQUEST, VERIFIED-PERMIT COMMIT** |
| Command construction boundary | **OPAQUE VALIDATED COMMIT ONLY; DIRECT ACTION/PROOF/PERMIT CONSTRUCTOR REMOVED** |
