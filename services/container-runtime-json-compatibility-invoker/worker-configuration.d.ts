/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/container-runtime-json-compatibility-invoker/wrangler.jsonc --env-interface=JsonCompatibilityInvokerGeneratedEnv services/container-runtime-json-compatibility-invoker/worker-configuration.d.ts` (hash: 790743f0dd9404fc8bb06b4fd435057d)
// Runtime types generated with workerd@1.20260708.1 2026-08-04 
interface __BaseEnv_JsonCompatibilityInvokerGeneratedEnv {
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ENVIRONMENT: "local";
	JSON_COMPATIBILITY_INVOKER_ENABLED: "false";
	JSON_COMPATIBILITY_INVOKER_STATUS_READ_ENABLED: "false";
	JSON_COMPATIBILITY_INVOKER_OPERATOR_ISSUER: "cinatoken-json-compatibility-campaign-operator-staging";
	JSON_COMPATIBILITY_INVOKER_OPERATOR_AUDIENCE: "cinatoken-container-runtime-json-compatibility-invoker-staging";
	...
	JSON_COMPATIBILITY_INVOKER_STATUS_OPERATOR_ISSUER: "cinatoken-json-compatibility-campaign-operator-status-staging";
	JSON_COMPATIBILITY_INVOKER_STATUS_OPERATOR_AUDIENCE: "cinatoken-container-runtime-json-compatibility-invoker-staging";
	...
	JSON_COMPATIBILITY_INVOKER_ISSUER_HMAC_ISSUER: "cinatoken-container-runtime-json-compatibility-invoker-staging";
	JSON_COMPATIBILITY_INVOKER_ISSUER_HMAC_AUDIENCE: "cinatoken-container-runtime-json-compatibility-permit-issuer-staging";
	JSON_COMPATIBILITY_INVOKER_ISSUER_HMAC_KID: "";
	JSON_COMPATIBILITY_INVOKER_ISSUER_HMAC_CREDENTIAL_ID_SHA256: "";
	JSON_COMPATIBILITY_PERMIT_ISSUER: "cinatoken-json-compatibility-permit-issuer-staging";
	JSON_COMPATIBILITY_PERMIT_AUDIENCE: "cinatoken-container-runtime-json-compatibility-executor-staging";
	JSON_COMPATIBILITY_PERMIT_KEY_ID: "";
	JSON_COMPATIBILITY_PERMIT_SPKI_SHA256: "";
	JSON_COMPATIBILITY_INVOCATION_AUTHORITY: DurableObjectNamespace<import("./src/index").JsonCompatibilityInvocationAuthority>;
	JSON_COMPATIBILITY_PERMIT_ISSUER_SERVICE: Service /* entrypoint JsonCompatibilityPermitIssuerEntrypoint from cinatoken-container-runtime-json-compatibility-permit-issuer-staging */;
	JSON_COMPATIBILITY_EXECUTOR_SERVICE: Service /* entrypoint JsonCompatibilityCampaignExecutorEntrypoint from cinatoken-container-runtime-json-compatibility-executor-staging */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "JsonCompatibilityInvocationAuthority";
	}
	interface Env extends __BaseEnv_JsonCompatibilityInvokerGeneratedEnv {}
}
interface JsonCompatibilityInvokerGeneratedEnv extends __BaseEnv_JsonCompatibilityInvokerGeneratedEnv {}
