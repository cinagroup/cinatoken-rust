...
| Legacy Baidu/Zhipu v3/Tencent/Xunfei regional adapters | 15, 16, 18, 23 | Planned. Type 16 stays Deferred pending channel migration to type 26 because the current official Zhipu API index exposes v4, not the source v3 invoke protocol. Ali(17), VolcEngine(45), and BaiduV2(46) are tracked in the dedicated row above. | Adapter fixtures, auth headers, error normalization, usage parser parity; inventory and operator-approved type-15 to type-46 and type-16 to type-26 conversion before cutover. |
