/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/shard-placement-authority/wrangler.jsonc --env-interface=ShardPlacementAuthorityEnv services/shard-placement-authority/worker-configuration.d.ts` (hash: ef6445f9ea1b8c4e4f8b60cc17554156)
