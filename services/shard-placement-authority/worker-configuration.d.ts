/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/shard-placement-authority/wrangler.jsonc --env-interface=ShardPlacementAuthorityEnv services/shard-placement-authority/worker-configuration.d.ts` (hash: c83fd6c3a2be36cc5293510a1dce77e0)
