/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/drain-source-registration-coordinator/wrangler.jsonc --env-interface=DrainSourceRegistrationCoordinatorEnv services/drain-source-registration-coordinator/worker-configuration.d.ts` (hash: 7b3fe07e25252f5a38ec0cb1aa405822)
// Runtime types generated with workerd@1.20260708.1 2026-07-28 
interface __BaseEnv_DrainSourceRegistrationCoordinatorEnv {
	CF_VERSION_METADATA: WorkerVersionMetadata;
	DRAIN_SOURCE_REGISTRATION_COORDINATOR_ENVIRONMENT: "local";
	DRAIN_SOURCE_REGISTRATION_COORDINATOR_ENABLED: "false";
	DRAIN_SOURCE_REGISTRATION_COORDINATOR_AUTHORITY_ISSUER: "cinatoken-rust-api-local";
	DRAIN_SOURCE_REGISTRATION_COORDINATOR_AUTHORITY_AUDIENCE: "cinatoken-drain-source-registration-coordinator-local";
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_DrainSourceRegistrationCoordinatorEnv {}
}
interface DrainSourceRegistrationCoordinatorEnv extends __BaseEnv_DrainSourceRegistrationCoordinatorEnv {}
