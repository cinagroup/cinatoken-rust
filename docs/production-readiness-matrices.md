...
`realtime_session_billing_settlement_audit_log_compiled` signals. These are
...
audit row, idempotency/CAS proof, and staging replay evidence are archived.
