...
- **Status (2026-07-08): Gated substrate, default-off settlement writer compiled.** The DO with WS
  ...
  **Remaining:** production bridge hardening (archived local/staging
  ...
  calculation, settlement mutation planning, and the default-off D1 writer are
  compiled; durable settlement idempotency, final audit rows, staging replay
  proof, and the Go-formula settlement below remain incomplete.
