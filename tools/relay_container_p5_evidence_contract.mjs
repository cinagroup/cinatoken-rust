...
const EXPECTED_SCHEMA_MIGRATION_COUNT = 70;
const EXPECTED_SCHEMA_TABLE_COUNT = 92;
const EXPECTED_SCHEMA_INCREMENTAL_COLUMN_COUNT = 1463;
const EXPECTED_SCHEMA_KEY_INDEX_COUNT = 137;
