...
| Remaining external payment callbacks/topups | Keep Creem/Waffo wallet checkout/callbacks and external subscription providers on Go until provider-specific signature/replay evidence exists; Stripe, Epay, and Waffo Pancake wallet paths are Worker-owned | Scenario C |
