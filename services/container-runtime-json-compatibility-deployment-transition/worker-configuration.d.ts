/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.jsonc --env-interface=JsonCompatibilityDeploymentTransitionGeneratedEnv` (hash: 0532aea770adad28b1e98f506b37b7ef)
// Runtime types generated with workerd@1.20260708.1 2026-08-05 nodejs_compat
interface __BaseEnv_JsonCompatibilityDeploymentTransitionGeneratedEnv {
	DB: D1Database;
	...
	JSON_COMPATIBILITY_DEPLOYMENT_TRANSITION_SERVICE_NAME: "cinatoken-container-runtime-json-compatibility-deployment-transition-local";
	JSON_COMPATIBILITY_DEPLOYMENT_READBACK_SERVICE_NAME: "cinatoken-container-runtime-json-compatibility-deployment-readback-staging";
	JSON_COMPATIBILITY_DEPLOYMENT_MUTATION_SERVICE_NAME: "cinatoken-container-runtime-json-compatibility-deployment-mutation-staging";
	JSON_COMPATIBILITY_SOURCE_VERIFIER_SERVICE_NAME: "cinatoken-container-runtime-json-compatibility-source-verifier-staging";
	JSON_COMPATIBILITY_DEPLOYMENT_READBACK: Service /* entrypoint JsonCompatibilityDeploymentReadbackEntrypoint from cinatoken-container-runtime-json-compatibility-deployment-readback-staging */;
	JSON_COMPATIBILITY_DEPLOYMENT_MUTATION: Service /* entrypoint JsonCompatibilityDeploymentMutationEntrypoint from cinatoken-container-runtime-json-compatibility-deployment-mutation-staging */;
	JSON_COMPATIBILITY_SOURCE_VERIFIER: Service /* entrypoint JsonCompatibilitySourceVerifierEntrypoint from cinatoken-container-runtime-json-compatibility-source-verifier-staging */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env extends __BaseEnv_JsonCompatibilityDeploymentTransitionGeneratedEnv {}
}
interface JsonCompatibilityDeploymentTransitionGeneratedEnv extends __BaseEnv_JsonCompatibilityDeploymentTransitionGeneratedEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "JSON_COMPATIBILITY_DEPLOYMENT_TRANSITION_ENABLED" | "JSON_COMPATIBILITY_DEPLOYMENT_TRANSITION_EXECUTION_ENABLED" | "JSON_COMPATIBILITY_DEPLOYMENT_TRANSITION_STATUS_READ_ENABLED" | "JSON_COMPATIBILITY_DEPLOYMENT_TRANSITION_PROFILE_VERSION" | "JSON_COMPATIBILITY_DEPLOYMENT_TRANSITION_SERVICE_NAME" | "JSON_COMPATIBILITY_DEPLOYMENT_READBACK_SERVICE_NAME" | "JSON_COMPATIBILITY_DEPLOYMENT_MUTATION_SERVICE_NAME" | "JSON_COMPATIBILITY_SOURCE_VERIFIER_SERVICE_NAME">> {}
}
