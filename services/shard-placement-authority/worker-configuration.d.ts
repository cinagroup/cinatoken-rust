/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/shard-placement-authority/wrangler.jsonc --env-interface=ShardPlacementAuthorityEnv services/shard-placement-authority/worker-configuration.d.ts` (hash: 55d0be735c88fb149271b910a8a0273b)
