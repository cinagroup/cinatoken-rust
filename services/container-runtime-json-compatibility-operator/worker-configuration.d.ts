/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/container-runtime-json-compatibility-operator/wrangler.jsonc --env-interface=JsonCompatibilityOperatorGeneratedEnv services/container-runtime-json-compatibility-operator/worker-configuration.d.ts` (hash: 8b9ab2ea52c7b17c5941290aeef1515f)
