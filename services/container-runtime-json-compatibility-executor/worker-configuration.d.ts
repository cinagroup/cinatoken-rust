/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/container-runtime-json-compatibility-executor/wrangler.jsonc --env-interface=JsonCompatibilityExecutorGeneratedEnv services/container-runtime-json-compatibility-executor/worker-configuration.d.ts` (hash: 5e8190c8844e5658e67ff5cd9d165289)
