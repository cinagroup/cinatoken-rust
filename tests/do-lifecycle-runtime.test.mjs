  ...
  it("reports HTTP pre-bind fencing and a fail-closed scheduled terminalizer", async () => {
    ...
    expect(payload).toMatchObject({
      ...
      data: {
        ...
        d1_migration_applied_count: 75,
        d1_migration_latest: "0075_root_authority_exactness.sql",
        d1_expected_migration: "0075_root_authority_exactness.sql",
        ...
        container_chat_canary_atomic_admission_compiled: true,
        container_chat_canary_atomic_admission_schema_ready: true,
        container_scheduled_terminalizer_compiled: true,
        container_scheduled_terminalizer_configured: false,
        container_scheduled_terminalizer_config_valid: false,
        container_scheduled_terminalizer_requested: false,
        ...
        container_traffic_return_evidence_schema_ready: true,
        container_drain_close_command_schema_ready: true,
        container_drain_source_seal_schema_ready: true,
        container_drain_source_authorization_schema_ready: true,
        ...
        container_drain_write_gates_all_false: true,
        ...
        container_chat_canary_replay_compiled: true,
        container_chat_canary_r2_binding_available: true,
        container_chat_canary_terminal_replay_runtime_ready: false,
        container_chat_canary_dispatched_recovery_runtime_ready: false,
        container_chat_canary_prepared_resume_runtime_ready: false,
        container_chat_canary_replay_runtime_ready: false,
        container_chat_canary_replay_cohort_configured: false,
        container_chat_canary_replay_only_enabled: false,
        container_chat_canary_replay_only_active: false,
        container_chat_canary_prepared_resume_enabled: false,
        container_chat_canary_current_idempotency_secret_configured: false,
        container_chat_canary_previous_idempotency_secret_configured: false,
