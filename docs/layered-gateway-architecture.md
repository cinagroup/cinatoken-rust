...
- **Status (2026-07-08): Gated substrate, settlement mutation plan compiled.** The DO with WS
  ...
  **Remaining:** production bridge hardening (archived local/staging
  ...
  calculation, and settlement mutation planning are compiled; D1 quota reserve,
