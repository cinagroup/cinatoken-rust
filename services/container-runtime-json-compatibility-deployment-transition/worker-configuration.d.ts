/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.jsonc --env-interface=JsonCompatibilityDeploymentTransitionGeneratedEnv` (hash: 7f0665c132b51ac3f0211df78a1d1d0a)
...
interface __BaseEnv_JsonCompatibilityDeploymentTransitionGeneratedEnv {
	...
	JSON_COMPATIBILITY_DEPLOYMENT_LEAF_SERVICE_NAME: "cinatoken-container-runtime-json-compatibility-deployment-leaf-staging";
	JSON_COMPATIBILITY_SOURCE_VERIFIER_SERVICE_NAME: "cinatoken-container-runtime-json-compatibility-source-verifier-staging";
	JSON_COMPATIBILITY_DEPLOYMENT_LEAF: Service /* entrypoint JsonCompatibilityDeploymentLeafEntrypoint from cinatoken-container-runtime-json-compatibility-deployment-leaf-staging */;
