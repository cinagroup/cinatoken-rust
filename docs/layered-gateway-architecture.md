...
- **Status (2026-07-06): Gated substrate, upstream event trace compiled.** The DO with WS
  ...
  **Remaining:** production bridge hardening (archived local/staging
  ...
  accumulation and pre-settlement billing snapshot are compiled; quota reserve,
  refund, final audit settlement, and the Go-formula settlement below remain
  unimplemented.
