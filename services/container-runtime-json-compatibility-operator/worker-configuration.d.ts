/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/container-runtime-json-compatibility-operator/wrangler.jsonc --env-interface=JsonCompatibilityOperatorGeneratedEnv services/container-runtime-json-compatibility-operator/worker-configuration.d.ts` (hash: 63e83d634d5de9e474d0a8ada27bd9f6)
// Runtime types generated with workerd@1.20260708.1 2026-08-04 
interface __BaseEnv_JsonCompatibilityOperatorGeneratedEnv {
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ENVIRONMENT: "local";
	JSON_COMPATIBILITY_OPERATOR_ENABLED: "false";
	JSON_COMPATIBILITY_OPERATOR_STATUS_READ_ENABLED: "false";
	JSON_COMPATIBILITY_OPERATOR_ISSUER: "cinatoken-json-compatibility-campaign-operator-staging";
	JSON_COMPATIBILITY_OPERATOR_AUDIENCE: "cinatoken-container-runtime-json-compatibility-invoker-staging";
	JSON_COMPATIBILITY_OPERATOR_APPROVAL_ISSUER: "cinatoken-json-compatibility-campaign-approval-authority-staging";
	JSON_COMPATIBILITY_OPERATOR_APPROVAL_AUDIENCE: "cinatoken-container-runtime-json-compatibility-operator-staging";
	...
	JSON_COMPATIBILITY_OPERATOR_STATUS_ISSUER: "cinatoken-json-compatibility-campaign-operator-status-staging";
	JSON_COMPATIBILITY_OPERATOR_STATUS_AUDIENCE: "cinatoken-container-runtime-json-compatibility-invoker-staging";
	...
	JSON_COMPATIBILITY_INVOKER_SERVICE: Service /* entrypoint JsonCompatibilityCampaignInvokerEntrypoint from cinatoken-container-runtime-json-compatibility-invoker-staging */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env extends __BaseEnv_JsonCompatibilityOperatorGeneratedEnv {}
}
interface JsonCompatibilityOperatorGeneratedEnv extends __BaseEnv_JsonCompatibilityOperatorGeneratedEnv {}
