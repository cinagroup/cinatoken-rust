/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/controller-deployment-gateway/wrangler.jsonc --env-interface=ControllerDeploymentGatewayEnv services/controller-deployment-gateway/worker-configuration.d.ts` (hash: 2de427077d3f13b0cb91f50b9e6382e8)
