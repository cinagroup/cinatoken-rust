/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/container-runtime-json-compatibility-invoker/wrangler.jsonc --env-interface=JsonCompatibilityInvokerGeneratedEnv services/container-runtime-json-compatibility-invoker/worker-configuration.d.ts` (hash: 7b7b2f72fc04bba00063f4691826cf3c)
