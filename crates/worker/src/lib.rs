...
#[allow(dead_code)]
mod container_drain_source_registration_application_begin;
#[allow(dead_code)]
mod container_drain_source_registration_application_ceremony;
#[allow(dead_code)]
mod container_drain_source_registration_application_orchestrator;
#[allow(dead_code)]
mod container_drain_source_registration_application_session;
#[allow(dead_code)]
...
pub async fn fetch(req: Request, env: Env, ctx: Context) -> Result<Response> {
    ...
    let response = Router::with_data(ctx)
        ...
        .post_async(
            ...
            |req, ctx| async move {
                let ticket_id = ctx.param("ticket_id").cloned();
                container_shard_placement_activation_read::create_pre_enable_grant(
                    req,
                    ctx.env,
                    ticket_id,
                )
