/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/drain-source-registration-permit-issuer/wrangler.jsonc --env-interface=DrainSourceRegistrationPermitIssuerEnv services/drain-source-registration-permit-issuer/worker-configuration.d.ts` (hash: 40ce0bdb6f8ddc9c6048bca22ea72381)
// Runtime types generated with workerd@1.20260708.1 2026-07-15 
interface __BaseEnv_DrainSourceRegistrationPermitIssuerEnv {
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ENVIRONMENT: "local";
	DRAIN_SOURCE_REGISTRATION_PERMIT_ISSUER_ENABLED: "false";
	DRAIN_SOURCE_REGISTRATION_AUTHORITY_ISSUER: "cinatoken-relay-application-local";
	DRAIN_SOURCE_REGISTRATION_AUTHORITY_AUDIENCE: "cinatoken-drain-source-registration-permit-issuer-local";
	...
	DRAIN_SOURCE_REGISTRATION_PERMIT_ISSUER: "cinatoken-drain-source-registration-permit-issuer-local";
	DRAIN_SOURCE_REGISTRATION_PERMIT_AUDIENCE: "cinatoken-relay-application:local:drain-source-registration:v1";
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_DrainSourceRegistrationPermitIssuerEnv {}
}
interface DrainSourceRegistrationPermitIssuerEnv extends __BaseEnv_DrainSourceRegistrationPermitIssuerEnv {}
