...
Audit correction (2026-07-13): Rust currently accepts 23 D1 import target
tables but deterministic source/target reconciliation covers only 11. G2 must
remain blocked until every importable family has canonical count/hash/sample
and relationship checks, or a reviewed exclusion/rebuild manifest. In
particular, successful import alone is not evidence for logs, tasks, checkins,
redemptions, subscriptions, models, vendors, or OAuth tables.
