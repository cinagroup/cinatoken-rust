/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=ShardPlacementAuthorityEnv` (hash: 0469dbc589ddc7eaaae1e0777e267a5f)
// Runtime types generated with workerd@1.20260708.1 2026-07-28 
interface __BaseEnv_ShardPlacementAuthorityEnv {
	DB: D1Database;
	...
	SHARD_PLACEMENT_AUTHORITY_PRE_ENABLE_GRANT_WRITE_ENABLED: "false";
	...
	SHARD_PLACEMENT_AUTHORITY_DISPATCH_CONSUMPTION_WRITE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_DISPATCH_CONSUMPTION_RECEIPT_WRITE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_DISPATCH_CONSUMPTION_RECOVERY_READ_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_DISPATCH_CONSUMPTION_RECOVERY_RECEIPT_WRITE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_SEND_ATTEMPT_WRITE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_GATEWAY_EVENT_WRITE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_OPERATION_FIVE_TERMINAL_WRITE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_READINESS_PROBE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_READINESS_READBACK_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_READINESS_ATTEMPT_WRITE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_READINESS_TERMINAL_WRITE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_OPERATION_FOURTEEN_DISABLE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_OPERATION_FOURTEEN_READBACK_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_OPERATION_FOURTEEN_ATTEMPT_WRITE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_OPERATION_FOURTEEN_EVENT_WRITE_ENABLED: "false";
	SHARD_PLACEMENT_AUTHORITY_OPERATION_FOURTEEN_TERMINAL_WRITE_ENABLED: "false";
	...
	CONTROLLER_DISABLE_ATTESTATION_AUTHORITY_ISSUER: "cinatoken-shard-placement-authority-local";
	CONTROLLER_DISABLE_ATTESTATION_AUTHORITY_AUDIENCE: "cinatoken-container-controller-local";
	CONTROLLER_DISABLE_ATTESTATION_CURRENT_KID: "";
	CONTROLLER_DISABLE_ATTESTATION_PREVIOUS_KID: "";
	CONTAINER_CONTROLLER_READINESS_ISSUER: "cinatoken-shard-placement-authority-local";
	CONTAINER_CONTROLLER_READINESS_AUDIENCE: "cinatoken-container-controller-local";
	...
	SHARD_PLACEMENT_APPLICATION_ISSUER: "cinatoken-shard-placement-authority-local";
	SHARD_PLACEMENT_APPLICATION_AUDIENCE: "cinatoken-rust-api-local";
	...
	SHARD_PLACEMENT_APPLICATION_DISPATCH_CONSUMPTION_RECOVERY_RETENTION_SECONDS: "2592000";
	...
	SHARD_PLACEMENT_AUTHORITY_ISSUER: "cinatoken-shard-placement-operator-local";
	SHARD_PLACEMENT_AUTHORITY_AUDIENCE: "cinatoken-shard-placement-authority-local";
	SHARD_PLACEMENT_AUTHORITY_POLICY_ID: "";
	SHARD_PLACEMENT_AUTHORITY_POLICY_SHA256: "";
	SHARD_PLACEMENT_PERMIT_ISSUER: "cinatoken-shard-placement-permit-issuer-local";
	...
	SHARD_PLACEMENT_APPLICATION: Fetcher /* cinatoken-rust-api-local */;
	CONTROLLER_DEPLOYMENT_GATEWAY: Fetcher /* cinatoken-controller-deployment-gateway-local */;
	CONTAINER_CONTROLLER: Fetcher /* cinatoken-container-controller-local */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env extends __BaseEnv_ShardPlacementAuthorityEnv {}
}
interface ShardPlacementAuthorityEnv extends __BaseEnv_ShardPlacementAuthorityEnv {}
