/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/controller-deployment-gateway/wrangler.jsonc --env-interface=ControllerDeploymentGatewayEnv services/controller-deployment-gateway/worker-configuration.d.ts` (hash: 795a26e92521415dfae4646788224198)
// Runtime types generated with workerd@1.20260708.1 2026-07-29 nodejs_compat
interface __BaseEnv_ControllerDeploymentGatewayEnv {
	DB: D1Database;
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ENVIRONMENT: "local";
	CONTROLLER_DEPLOYMENT_GATEWAY_ENABLED: "false";
	CONTROLLER_DEPLOYMENT_GATEWAY_CREATE_ENABLED: "false";
	CONTROLLER_DEPLOYMENT_GATEWAY_STATUS_READ_ENABLED: "false";
	CONTROLLER_DEPLOYMENT_GATEWAY_REMOTE_MUTATION_ENABLED: "false";
	CONTROLLER_DEPLOYMENT_GATEWAY_REMOTE_READ_ENABLED: "false";
	CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_CREATE_ENABLED: "false";
	CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_STATUS_READ_ENABLED: "false";
	CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_REMOTE_MUTATION_ENABLED: "false";
	CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_REMOTE_READ_ENABLED: "false";
	CONTROLLER_DEPLOYMENT_GATEWAY_PROFILE_VERSION: "1";
	CONTROLLER_DEPLOYMENT_GATEWAY_STATUS_STABILITY_MIN_SECONDS: "5";
	CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_STATUS_STABILITY_MIN_SECONDS: "5";
	CONTROLLER_DEPLOYMENT_GATEWAY_CONTROLLER_SERVICE_NAME: "cinatoken-container-controller-local";
	CONTROLLER_DEPLOYMENT_GATEWAY_ISSUER: "cinatoken-shard-placement-authority-local";
	CONTROLLER_DEPLOYMENT_GATEWAY_AUDIENCE: "cinatoken-controller-deployment-gateway-local";
	...
	CLOUDFLARE_ACCOUNT_ID: "local-account-placeholder";
	CLOUDFLARE_ACCOUNT_ID_SHA256: "d020d17d50f44a2a226494afbb5d4d96712f14bf33aa9adfb63a563fb6824edd";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env extends __BaseEnv_ControllerDeploymentGatewayEnv {}
}
interface ControllerDeploymentGatewayEnv extends __BaseEnv_ControllerDeploymentGatewayEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CONTROLLER_DEPLOYMENT_GATEWAY_ENABLED" | "CONTROLLER_DEPLOYMENT_GATEWAY_CREATE_ENABLED" | "CONTROLLER_DEPLOYMENT_GATEWAY_STATUS_READ_ENABLED" | "CONTROLLER_DEPLOYMENT_GATEWAY_REMOTE_MUTATION_ENABLED" | "CONTROLLER_DEPLOYMENT_GATEWAY_REMOTE_READ_ENABLED" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_CREATE_ENABLED" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_STATUS_READ_ENABLED" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_REMOTE_MUTATION_ENABLED" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_REMOTE_READ_ENABLED" | "CONTROLLER_DEPLOYMENT_GATEWAY_PROFILE_VERSION" | "CONTROLLER_DEPLOYMENT_GATEWAY_STATUS_STABILITY_MIN_SECONDS" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_STATUS_STABILITY_MIN_SECONDS" | "CONTROLLER_DEPLOYMENT_GATEWAY_CONTROLLER_SERVICE_NAME" | "CONTROLLER_DEPLOYMENT_GATEWAY_ISSUER" | "CONTROLLER_DEPLOYMENT_GATEWAY_AUDIENCE" | "CONTROLLER_DEPLOYMENT_GATEWAY_CREATE_HMAC_CURRENT_KID" | "CONTROLLER_DEPLOYMENT_GATEWAY_CREATE_HMAC_CURRENT_CREDENTIAL_ID_SHA256" | "CONTROLLER_DEPLOYMENT_GATEWAY_CREATE_HMAC_PREVIOUS_KID" | "CONTROLLER_DEPLOYMENT_GATEWAY_CREATE_HMAC_PREVIOUS_CREDENTIAL_ID_SHA256" | "CONTROLLER_DEPLOYMENT_GATEWAY_STATUS_HMAC_CURRENT_KID" | "CONTROLLER_DEPLOYMENT_GATEWAY_STATUS_HMAC_CURRENT_CREDENTIAL_ID_SHA256" | "CONTROLLER_DEPLOYMENT_GATEWAY_STATUS_HMAC_PREVIOUS_KID" | "CONTROLLER_DEPLOYMENT_GATEWAY_STATUS_HMAC_PREVIOUS_CREDENTIAL_ID_SHA256" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_CREATE_HMAC_CURRENT_KID" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_CREATE_HMAC_CURRENT_CREDENTIAL_ID_SHA256" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_CREATE_HMAC_PREVIOUS_KID" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_CREATE_HMAC_PREVIOUS_CREDENTIAL_ID_SHA256" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_STATUS_HMAC_CURRENT_KID" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_STATUS_HMAC_CURRENT_CREDENTIAL_ID_SHA256" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_STATUS_HMAC_PREVIOUS_KID" | "CONTROLLER_DEPLOYMENT_GATEWAY_DISABLE_STATUS_HMAC_PREVIOUS_CREDENTIAL_ID_SHA256" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_ACCOUNT_ID_SHA256">> {}
}
