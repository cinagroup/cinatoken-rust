...
function validateCandidate(value) {
  ...
  requireExact(candidate.migrationCount, 65, "[candidate] migration count");
...
function validateSchemaReadback(facts) {
  ...
  requireExact(facts.migrationCount, 65, "[schema-readback] migration count");
  requireExact(facts.tableCount, 76, "[schema-readback] table count");
  requireExact(facts.incrementalColumnCount, 1056, "[schema-readback] incremental columns");
  requireExact(facts.keyIndexCount, 110, "[schema-readback] key indexes");
