...
from 122 to 106 by closing routes and removing one false-positive call:
...
106 calls with a stable SHA-256 route-set digest and category counts. New
...
payment families, operations work, and 10 visible admin gaps. Local wrapper
